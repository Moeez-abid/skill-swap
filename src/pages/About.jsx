    ...
    <div style={{ paddingTop: '130px', paddingBottom: '64px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <section className="glass-card reveal" style={{ padding: '32px', marginBottom: '32px' }}>
        ...
        <ul style={{ lineHeight: '1.7', color: 'var(--text-secondary)', paddingLeft: '20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
          <li className="reveal reveal-delay-1"><strong style={{ color: 'var(--text-primary)' }}>Collaboration</strong><br/>Learning is better when people help one another.</li>
          <li className="reveal reveal-delay-2"><strong style={{ color: 'var(--text-primary)' }}>Trust</strong><br/>A respectful and reliable community comes first.</li>
          <li className="reveal reveal-delay-3"><strong style={{ color: 'var(--text-primary)' }}>Accessibility</strong><br/>Learning opportunities should be available to everyone.</li>
          <li className="reveal reveal-delay-1"><strong style={{ color: 'var(--text-primary)' }}>Growth</strong><br/>Every new skill opens the door to new possibilities.</li>
          <li className="reveal reveal-delay-2"><strong style={{ color: 'var(--text-primary)' }}>Innovation</strong><br/>Continuously improving the way people connect and learn.</li>
          <li className="reveal reveal-delay-3"><strong style={{ color: 'var(--text-primary)' }}>Inclusivity</strong><br/>Everyone is welcome, regardless of background or experience.</li>
        </ul>
      </section>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px', marginBottom: '32px' }}>
        <section className="glass-card reveal" style={{ padding: '32px' }}>
          ...
          <ul style={{ lineHeight: '1.7', color: 'var(--text-secondary)', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <li className="reveal reveal-delay-1">Learn practical skills from people with real experience.</li>
            <li className="reveal reveal-delay-2">Share your knowledge and make a positive impact.</li>
            <li className="reveal reveal-delay-3">Connect with learners and skilled professionals from different backgrounds.</li>
            <li className="reveal reveal-delay-1">Discover opportunities to grow both personally and professionally.</li>
            <li className="reveal reveal-delay-2">Enjoy a simple, secure, and easy-to-use platform designed for meaningful learning.</li>
          </ul>
        </section>
        ...
        <section className="glass-card reveal reveal-delay-1" style={{ padding: '32px' }}>
          ...
          <ol style={{ lineHeight: '1.7', color: 'var(--text-secondary)', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <li className="reveal reveal-delay-1"><strong style={{ color: 'var(--text-primary)' }}>Create your account.</strong></li>
            <li className="reveal reveal-delay-2"><strong style={{ color: 'var(--text-primary)' }}>Tell others</strong> what you can teach or what you'd like to learn.</li>
            <li className="reveal reveal-delay-3"><strong style={{ color: 'var(--text-primary)' }}>Connect</strong> with people who share your interests.</li>
            <li className="reveal reveal-delay-1"><strong style={{ color: 'var(--text-primary)' }}>Learn, teach, and exchange</strong> knowledge through meaningful sessions.</li>
            <li className="reveal reveal-delay-2"><strong style={{ color: 'var(--text-primary)' }}>Continue growing</strong> your skills while helping others grow theirs.</li>
          </ol>
        </section>
      </div>
